...
import examen_20230314.controller.ConnectionManager;
...
//		gbl_contentPane.rowWeights = new double[]{Double.MIN_VALUE};
		...
		Button button = new Button("Cargar niveles");
		...
		Button button_1 = new Button("Cargar materias");
		...
		gbc_lblMateria.gridx = 1;
		gbc_lblMateria.gridy = 3;
		contentPane.add(lblMateria, gbc_lblMateria);
		...
		JButton btnNewButton = new JButton("Ver Materia");
		...
		JLabel lblNewLabel_7 = new JLabel("URL Classroom:");
